...
./megatt --tree ./inputs/140k-species-tree.nwk --names-map ./inputs/140k-species-map.txt --ranks ./inputs/140k-species-ranks.txt --target-rank species -ci ./inputs/140k-species-ci.csv -leaf-counts ./inputs/140k-leafNodeCounts.csv --ids ./ids/hominidae-alphabetical-desc.txt --o2 ./inputs/O2.txt --co2 ./inputs/CO2.txt --luminosity ./inputs/luminosity.txt --outfile ./outputs/hominidae-alphabetical-desc.svg --prune --earth-impacts ./inputs/earth_impacts.csv --width 900 -geo-bg-colors periods -tree-name timetree -gs
if [ $? = 0 ]; then
...
./megatt --tree ./inputs/140k-species-tree.nwk --names-map ./inputs/140k-species-map.txt --ranks ./inputs/140k-species-ranks.txt --target-rank species -ci ./inputs/140k-species-ci.csv -leaf-counts ./inputs/140k-leafNodeCounts.csv --ids ./ids/hominidae-HS-first.txt --o2 ./inputs/O2.txt --co2 ./inputs/CO2.txt --luminosity ./inputs/luminosity.txt --outfile ./outputs/hominidae-HS-first.svg --prune --earth-impacts ./inputs/earth_impacts.csv --width 900 -geo-bg-colors periods -tree-name timetree -gs
if [ $? = 0 ]; then
...
./megatt --tree ./inputs/140k-species-tree.nwk --names-map ./inputs/140k-species-map.txt --ranks ./inputs/140k-species-ranks.txt --target-rank species -ci ./inputs/140k-species-ci.csv -leaf-counts ./inputs/140k-leafNodeCounts.csv --ids ./ids/hominidae-HS-last.txt --o2 ./inputs/O2.txt --co2 ./inputs/CO2.txt --luminosity ./inputs/luminosity.txt --outfile ./outputs/hominidae-HS-last.svg --prune --earth-impacts ./inputs/earth_impacts.csv --width 900 -geo-bg-colors periods -tree-name timetree -gs
if [ $? = 0 ]; then
...
./megatt --tree ./inputs/140k-species-tree.nwk --names-map ./inputs/140k-species-map.txt --ranks ./inputs/140k-species-ranks.txt --target-rank species -ci ./inputs/140k-species-ci.csv -leaf-counts ./inputs/140k-leafNodeCounts.csv --ids ./ids/hominidae-numerical-asc.txt --o2 ./inputs/O2.txt --co2 ./inputs/CO2.txt --luminosity ./inputs/luminosity.txt --outfile ./outputs/hominidae-numerical-asc.svg --prune --earth-impacts ./inputs/earth_impacts.csv --width 900 -geo-bg-colors periods -tree-name timetree -gs
if [ $? = 0 ]; then
...
./megatt --tree ./inputs/140k-species-tree.nwk --names-map ./inputs/140k-species-map.txt --ranks ./inputs/140k-species-ranks.txt --target-rank species -ci ./inputs/140k-species-ci.csv -leaf-counts ./inputs/140k-leafNodeCounts.csv --ids ./ids/hominidae-numerical-desc.txt --o2 ./inputs/O2.txt --co2 ./inputs/CO2.txt --luminosity ./inputs/luminosity.txt --outfile ./outputs/hominidae-numerical-desc.svg --prune --earth-impacts ./inputs/earth_impacts.csv --width 900 -geo-bg-colors periods -tree-name timetree -gs
if [ $? = 0 ]; then
...
./megatt --tree ./inputs/140k-species-tree.nwk --names-map ./inputs/140k-species-map.txt --ranks ./inputs/140k-species-ranks.txt --target-rank species -ci ./inputs/140k-species-ci.csv -leaf-counts ./inputs/140k-leafNodeCounts.csv --ids ./ids/hominidae-splits.txt --o2 ./inputs/O2.txt --co2 ./inputs/CO2.txt --luminosity ./inputs/luminosity.txt --outfile ./outputs/hominidae-splits.svg --prune --earth-impacts ./inputs/earth_impacts.csv --width 900 -geo-bg-colors periods -tree-name timetree -gs
if [ $? = 0 ]; then
