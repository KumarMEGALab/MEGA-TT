...
begin
  ...
  WriteLn('    -panel-height --panel-height');
  ...
  WriteLn('    -geo-bg-colors --geo-bg-colors');
  ...
  WriteLn('    -earth-impacts --earth-impacts');
  ...
  WriteLn('    -target-rank --target-rank');
  ...
  WriteLn('        ./megatt --pairwise ./inputs/lizard_bear.json --outfile ./output/lizard_bear.svg --width 700 --height 600 --earth-impacts ./inputs/earth_impacts.csv --o2 ./inputs/O2.txt --co2 ./inputs/CO2.txt --luminosity ./inputs/luminosity.txt');
  WriteLn('    Generate an SVG for timeline search results');
  WriteLn('        ./megatt --timeline ./inputs/human.json --width 600 --height 800 --outfile ./outputs/human.svg --earth-impacts ./inputs/earth_impacts.csv --o2 ./inputs/O2.txt --co2 ./inputs/CO2.txt --luminosity ./inputs/luminosity.txt');
